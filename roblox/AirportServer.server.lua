...
do
	...
	mpart(mega, "LoungeGlass", 0.12, 2.2, 9.5, -54.5, 1.1, 243.5, COL.glass, { Transparency = 0.55 })
	mpart(mega, "LoungeGlass2", 13, 2.2, 0.12, -61, 1.1, 248.2, COL.glass, { Transparency = 0.55 })
